...
import { Home, MessageSquare, FileText, PackageSearch, Settings, Bot, BookOpen, HelpCircle } from 'lucide-react';
...
export function Sidebar() {
  ...
  return (
    <div className="w-64 h-screen glass-panel rounded-none border-y-0 border-l-0 flex flex-col z-10">
