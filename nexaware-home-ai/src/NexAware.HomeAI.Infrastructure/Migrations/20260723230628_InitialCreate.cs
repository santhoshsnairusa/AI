        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IndexedOn = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documents_Households_HouseholdId",
                        column: x => x.HouseholdId,
                        principalTable: "Households",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HouseholdItems_Households_HouseholdId",
                        column: x => x.HouseholdId,
                        principalTable: "Households",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Conversations_Households_HouseholdId",
                        column: x => x.HouseholdId,
                        principalTable: "Households",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DocumentChunks_Households_HouseholdId",
                        column: x => x.HouseholdId,
                        principalTable: "Households",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "AIResponseFeedbacks",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ChatMessageId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsHelpful = table.Column<bool>(type: "boolean", nullable: true),
                    IsIncorrect = table.Column<bool>(type: "boolean", nullable: true),
                    IsIncomplete = table.Column<bool>(type: "boolean", nullable: true),
                    CorrectedAnswer = table.Column<string>(type: "text", nullable: true),
                    CreatedOn = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AIResponseFeedbacks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AIResponseFeedbacks_ChatMessages_ChatMessageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MessageCitations_DocumentChunks_DocumentChunkId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIResponseFeedbacks_ChatMessageId",
                table: "AIResponseFeedbacks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_HouseholdId",
                table: "Conversations",
                column: "HouseholdId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentChunks_HouseholdId",
                table: "DocumentChunks",
                column: "HouseholdId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HouseholdItems_HouseholdId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageCitations_DocumentChunkId",
                table: "MessageCitations",
